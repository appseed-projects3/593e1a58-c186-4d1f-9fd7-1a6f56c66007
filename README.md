...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-01 17:55`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/593e1a58-c186-4d1f-9fd7-1a6f56c66007.git
$ cd 593e1a58-c186-4d1f-9fd7-1a6f56c66007
```
